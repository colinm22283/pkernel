...
The kernel can be build by running `make` in the top level directory. Assuming the proper compilers are installed on the system a binary of the kernel will be generated at `build/bin/kernel.bin`.
