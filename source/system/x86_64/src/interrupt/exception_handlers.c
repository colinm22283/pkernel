...
__NORETURN void div0_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_DIV0, isr, NULL);
...
__NORETURN void nmi_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_NMI, isr, NULL);
...
__NORETURN void bp_int3_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_BP_INT3, isr, NULL);
...
__NORETURN void ovf_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_OVF, isr, NULL);
...
__NORETURN void bound_range_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_BOUND_RANGE, isr, NULL);
...
__NORETURN void invalid_opcode_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_INVALID_OPCODE, isr, NULL);
...
__NORETURN void device_not_avail_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_DEVICE_NOT_AVAIL, isr, NULL);
...
__NORETURN void double_fault_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_DOUBLE_FAULT, isr, NULL);
...
__NORETURN void coproc_segment_overrun_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_COPROC_SEGMENT_OVERRUN, isr, NULL);
...
__NORETURN void invalid_tss_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_INVALID_TSS, isr, NULL);
...
__NORETURN void segment_not_present_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_SEGMENT_NOT_PRESENT, isr, NULL);
...
__NORETURN void stack_segment_fault_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_STACK_SEGMENT_FAULT, isr, NULL);
...
__NORETURN void general_protection_fault_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_GENERAL_PROTECTION_FAULT, isr, NULL);
...
__NORETURN void page_fault_handler(task_state_record_t * isr, page_fault_error_code_t * error_code) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_PAGE_FAULT, isr, error_code);
...
__NORETURN void x87_fpu_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_X87_FPU, isr, NULL);
...
__NORETURN void alignment_check_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_ALIGNMENT_CHECK, isr, NULL);
...
__NORETURN void machine_check_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_MACHINE_CHECK, isr, NULL);
...
__NORETURN void simd_fpu_error_handler(task_state_record_t * isr) {
    ...
    interrupt_registry_invoke((interrupt_code_t) IC_SIMD_FPU_ERROR, isr, NULL);
